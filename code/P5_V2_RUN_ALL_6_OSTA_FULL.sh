...
exec > >(tee -a P5_V2_FULL_6_OSTA_MASTER.log) 2>&1
...
echo "============================================================"
echo "P5-V2 FORMAL FULL OST-A PROCESSING"
echo "============================================================"
...
[ -s P5_V2_OSTA_6RUN_MANIFEST.tsv ] || {
...
echo
echo "============================================================"
echo "ALL 6 OST-A RUNS PROCESSED"
echo "============================================================"
...
echo
echo "FULL_6_OSTA_PROCESSING_GATE = GREEN"
echo "COMPLETED_RUNS = 6"
echo "MPT_OUTCOME_REVEALED = FALSE"
echo "NEXT_STEP = BUILD_OSTA_SPECIFICITY_OUTCOME"
